...
chim = xr.open_mfdataset("/home/cr2/nhuneeus/RESULTS/CHIMERE2023/FDCYT-STGOPTOMTT/chim_STGOPTOMTT_202106*out.nc", chunks= 'auto')
...
for name, coords in sites.items():
    ...
    print(f"{name}: punto más cercano en ({lat2d[iy, ix]:.4f}, {lon2d[iy, ix]:.4f}), índice ({iy}, {ix})")
